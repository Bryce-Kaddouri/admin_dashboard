...
class CategoryAddScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return context.watch<CategoryProvider>().categoryModel != null
        ? Container(
            child: Column(
              children: [
                  ...
                  onPressed: () async {
                    ...
                    if (_formKey.currentState!.saveAndValidate()) {
                      ...
                      CategoryModel initialCategoryModel =
                          context.read<CategoryProvider>().categoryModel!;
                      CategoryModel newCategoryModel = initialCategoryModel;

                      if (name == initialCategoryModel.name &&
                          description == initialCategoryModel.description &&
                          image == null) {
                        print('no changes');
                        Get.snackbar(
                          'Error',
                        ...
                        if (image == null) {
                          ...
                          if (name != newCategoryModel.name) {
                            print('name changed');
                            newCategoryModel =
                                newCategoryModel.copyWith(name: name);
                          } else if (description !=
                              newCategoryModel.description) {
                            print('description changed');
                            newCategoryModel = newCategoryModel.copyWith(
                          ...
                          if (imageUrl != null) {
                            ...
                            newCategoryModel =
                                newCategoryModel.copyWith(imageUrl: imageUrl);
                            if (name != newCategoryModel.name) {
                              print('name changed');
                              newCategoryModel =
                                  newCategoryModel.copyWith(name: name);
                        ...
                        CategoryModel? updateRes = await context
                            .read<CategoryProvider>()
                            .updateCategory(newCategoryModel);
                        if (updateRes != null) {
                          print('success');
                          Get.snackbar(
                            'Success',
